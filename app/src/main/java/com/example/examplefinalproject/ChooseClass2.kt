...
class ChooseClass2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (extras != null) {
            ...
            isDegree = extras.getString("isDegree")
        ...
        btnNext.setOnClickListener {
            ...
            if (radioCheck(selectedTime1, selectedTime2, selectedTime3, selectedTime4)) {
                ...
                val nextScreen2 = Intent(this@ChooseClass2, Summary::class.java).apply {
                    putExtra("FirstName", firstName)
                    putExtra("LastName", lastname)
                    putExtra("phone", phone)
                    putExtra("BirthDate", birthDate)
                    putExtra("isDegree", isDegree)
