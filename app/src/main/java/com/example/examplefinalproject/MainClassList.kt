...
class MainClassList : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val txtDegree = findViewById(R.id.lblMajor) as TextView
        val btnNext = findViewById(R.id.btnNext) as Button

        val firstName = findViewById(R.id.txtxFirstName) as EditText
        val lastName = findViewById(R.id.txtLastName) as EditText
        val phone = findViewById(R.id.txtPhoneNumber) as EditText
